  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        <Image src="/uploads/demo/reno1.jpg" alt="Ristrutturazioni Noto G" fill priority className="object-cover opacity-40" />
        <div className="absolute inset-0 bg-gradient-to-t from-night via-night/60 to-night/30" />
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
          <Reveal>
            <p className="inline-flex items-center gap-2 rounded-full border border-gold/40 bg-panel/60 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-gold">
              <Hammer size={13} /> Ristrutturazioni
            </p>
          </Reveal>
          <Reveal delay={0.1}>
            <h1 className="mt-5 max-w-3xl font-display text-5xl font-bold text-white">
              Ristrutturazioni chiavi in mano, dal preventivo alla consegna.
            </h1>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mt-5 max-w-2xl text-lg text-slate-300">
              Un solo referente, zero stress. Trasformiamo il tuo immobile con tecnologie
              all&rsquo;avanguardia e il massimo rispetto per norme e tempi.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <Reveal>
          <h2 className="font-display text-4xl font-bold text-white">Come funziona</h2>
        </Reveal>
        <div className="mt-12 grid gap-6 md:grid-cols-4">
          {STEPS.map((s, i) => (
            <Reveal key={s.n} delay={0.1 * i}>
              <div className="h-full rounded-2xl border border-line/60 bg-panel/60 p-6">
                <span className="font-display text-4xl font-bold text-brand-soft">{s.n}</span>
      ...
      <section className="border-y border-line/60 bg-ink/50">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <Reveal>
              <h2 className="font-display text-4xl font-bold text-white">Cosa realizziamo</h2>
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                className="mt-9 inline-flex items-center gap-2 rounded-full bg-accent-green px-6 py-3 text-sm font-bold text-night hover:brightness-110"
              >
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <Reveal>
          <h2 className="font-display text-4xl font-bold text-white">FAQ ristrutturazioni</h2>
        </Reveal>
        <div className="mt-10 space-y-4">
          {[
            ...
            <Reveal key={f.q} delay={0.05 * i}>
              <details className="rounded-xl border border-line/60 bg-panel/60 px-6 py-5">
